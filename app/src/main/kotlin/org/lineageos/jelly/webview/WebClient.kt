...
internal class WebClient : WebViewClient() {
    ...
    override fun shouldOverrideUrlLoading(view: WebView, request: WebResourceRequest): Boolean {
        if (request.isForMainFrame) {
            ...
            if (!webViewExt.isIncognito
                ...
                return true
            } else if (!webViewExt.requestHeaders.isEmpty()) {
    ...
    override fun onReceivedHttpAuthRequest(view: WebView,
        ...
        builder.setView(dialogView)
                ...
                .setPositiveButton(R.string.auth_dialog_login
                    ...
                    handler.proceed(
                            view.username.text.toString(), view.password.text.toString())
                }
    ...
    private fun startActivityForUrl(view: WebView, url: String): Boolean {
        ...
        if (m.matches()) {
            val chooserIntent = makeHandlerChooserIntent(context, intent, url)
            ...
            if (packageName != null && context.packageManager.resolveActivity(intent, 0) == null) {
    ...
    private fun makeHandlerChooserIntent(context: Context, intent: Intent, url: String): Intent? {
        ...
        if (chooserIntents.isEmpty()) {
            ...
            return if (TextUtils.equals(lastIntent.`package`, ourPackageName)) null else lastIntent
        }

        val changeIntent = Intent(MainActivity.ACTION_URL_RESOLVED)
